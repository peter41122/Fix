      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-indigo-600">
          <div className="flex items-center">
            <button onClick="" className="text-gray-500 focus:outline-none lg:hidden">
          ...
          <div className="flex items-center">
            <div className="relative">
              <button onClick="" className="flex mx-4 text-gray-600 focus:outline-none">
                <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              <div x-show="notificationOpen" onClick=""
            ...
            <div className="relative">
              <button onClick="" className="relative block h-8 w-8 rounded-full overflow-hidden shadow focus:outline-none">
                <img className="h-full w-full object-cover"
                  src="https://images.unsplash.com/photo-1528892952291-009c663ce843?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=296&amp;q=80"
                  alt="Your avatar" />
              </button>

              <div x-show="dropdownOpen" onClick="" className="fixed inset-0 h-full w-full z-10"
